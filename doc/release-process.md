...
##perform gitian builds
 ...
 Build mobicoind and mobicoin-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit mobicoin=v${VERSION} ../mobicoin/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../mobicoin/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r mobicoin-${VERSION}-linux-gitian.zip *
	mv mobicoin-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit mobicoin=v${VERSION} ../mobicoin/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../mobicoin/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r mobicoin-${VERSION}-win-gitian.zip *
	mv mobicoin-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit mobicoin=v${VERSION} ../mobicoin/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
