...
#define QAPP_ORG_NAME "Mobicoin"
#define QAPP_ORG_DOMAIN "mobicoinpay.io"
#define QAPP_APP_NAME_DEFAULT "Mobicoin-Qt"
#define QAPP_APP_NAME_TESTNET "Mobicoin-Qt-testnet"
